...
export default function FetchError({ active }) {
  ...
  return (
    transition((styles, item) => item && (
      <a.div className="fixed inset-x-0 inset-y-1/2 lg:w-1/4 w-3/4 mx-auto z-50 flex flex-col justify-center items-center rounded-lg shadow-lg" style={styles} >
        ...
        <p className="text-red-700 w-full bg-gray-200 rounded-b-lg p-2">There was an error fetching updated vessel information.</p>
      </a.div>
    ))
  )
}
