  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-red-700 w-full bg-gray-200 rounded-b-lg p-2">There was an error fetching updated vessel information. You can refresh or try again later.</p>
      </div>
    </CSSTransition>
  )
}
